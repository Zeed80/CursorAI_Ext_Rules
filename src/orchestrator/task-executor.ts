...
**Важно:** После выполнения задачи сообщи о результате.`;
    ...
    private async sendToChat(message: string): Promise<void> {
        try {
            ...
            const action = await vscode.window.showInformationMessage(
                'Задача отправлена в CursorAI Chat. Сообщение скопировано в буфер обмена.',
                'Открыть чат',
            ...
            if (action === 'Открыть чат') {
                ...
                vscode.window.showInformationMessage(
                    'Вставьте сообщение из буфера обмена в чат CursorAI (Ctrl+V)',
                    'OK'
                );
            ...
            vscode.window.showWarningMessage(
                'Не удалось открыть чат автоматически. Сообщение скопировано в буфер обмена.',
                'OK'
            );
        }
    }
     ...
     */
    private async autoPasteToChat(text: string): Promise<void> {
