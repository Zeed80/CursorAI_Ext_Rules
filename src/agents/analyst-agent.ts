 ...
 */
export class AnalystAgent extends LocalAgent {
    constructor(context: vscode.ExtensionContext) {
        super(
            'analyst',
            'Data Analyst',
            'Специализируется на анализе: производительность, оптимизация, метрики, данные',
            context
        );
    }
...
- Масштабируемость решения`;
    ...
    private parseOptions(text: string): Omit<SolutionOption, 'id'>[] {
        ...
        const parsed = this.parseJSONOptions(text, 'AnalystAgent');
