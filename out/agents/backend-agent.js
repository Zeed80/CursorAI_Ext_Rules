 ...
 */
class BackendAgent extends local_agent_1.LocalAgent {
    constructor(context) {
        super('backend', 'Backend Developer', 'Специализируется на backend разработке: PHP, PostgreSQL, API, серверная логика, безопасность', context);
    }
